<template>
  ...
  <svg viewBox="-3 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
       xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" :fill="props.color" :width="props.width" :height="props.height">
    <g  stroke-width="0"></g>
    ...
    <g ><title>trash</title>
      ...
      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
        <g  sketch:type="MSLayerGroup" transform="translate(-259.000000, -203.000000)" :fill="props.color">
          <path
